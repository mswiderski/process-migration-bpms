...
public class AddErrorBoundaryEvent extends RemoteTestBase {

    private static final String PROCESS_ID_V1 = "process-migration-testv1.AddErrorBoundaryEvent";
    private static final String PROCESS_ID_V2 = "process-migration-testv2.AddErrorBoundaryEvent";
